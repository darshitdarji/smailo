                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              const Text("Order:"),
                                              Text(
                                                state.cancelledList.cancelledData[index]
                                                    .orderNo,
                                          ...
                                          InkWell(
                                            onTap: () {
                                              Navigator.push(
                                                ...
                                                MaterialPageRoute(
                                                  builder: (context) =>
                                                      CancelOderDetail(orderId: state.cancelledList.cancelledData[index].id.toString(),orderIdEncrypt: state.cancelledList.cancelledData[index].orderIdEncrypt,),
                                                ),
                                              );
                                            },
                                            child: Container(
