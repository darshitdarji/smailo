...
class CancelOderDetail extends StatefulWidget {
  ...
  @override
  State<CancelOderDetail> createState() => _CancelOderDetailState();
}

class _CancelOderDetailState extends State<CancelOderDetail> {
  @override
  Widget build(BuildContext context) {
    return BlocProvider<PendingOrderDetailBloc>(
      create: (context) => PendingOrderDetailBloc(),
      child: CancelOrderDetailPage(
...
class CancelOrderDetailPage extends StatefulWidget {
  final String orderId;
  final String orderIdEncrypt;

  const CancelOrderDetailPage(
      {super.key, required this.orderId, required this.orderIdEncrypt});

  @override
  State<CancelOrderDetailPage> createState() => _CancelOrderDetailPageState();
}

class _CancelOrderDetailPageState extends State<CancelOrderDetailPage> {
  int activeStep = 0;
