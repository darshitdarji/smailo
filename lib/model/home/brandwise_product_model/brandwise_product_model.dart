class BrandWiseListModel {
  final int status;
  final List<BrandWiseData> brandWiseData;
  final String message;

  BrandWiseListModel.fromJsonMap(Map<String, dynamic> map)
      : status = map['status'],
        brandWiseData = List<BrandWiseData>.from(
            map['data'].map((x) => BrandWiseData.fromJsonMap(x))),
        message = map['message'];
}
